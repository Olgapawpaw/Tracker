...
final class NewEventViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupTrackerName()
        setupButton()
        setupCollectionView(collectionView: emojiCollectionView, distanceToTableView: 230)
        setupCollectionView(collectionView: colorCollectionView, distanceToTableView: 468)
    }
    ...
    private func setupButton() {
        ...
        createButton.isEnabled = false
        NSLayoutConstraint.activate([
            cancelButton.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 706),
            cancelButton.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 20),
            cancelButton.widthAnchor.constraint(equalToConstant: 166),
            cancelButton.heightAnchor.constraint(equalToConstant: 60),
            createButton.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 706),
